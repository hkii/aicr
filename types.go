...
// pkg/snapshotter.Snapshot — no facade wrapper is needed because the
// type carries no per-Client lifetime state.
//
...
// don't need to import pkg/validator to filter by phase.
const (
