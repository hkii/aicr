...
Eidos provides **SBOMs in SPDX v2.3 JSON format** for comprehensive supply chain visibility:
  ...
  "packages": [
    {
      ...
      "externalRefs": [
        ...
        },
        {
          ...
          "referenceType": "purl",
          "referenceLocator": "pkg:golang/github.com/NVIDIA/eidos@v0.8.12"  // Example purl
        }
      ]
    },
```
...
gh run view 20642050863 --repo NVIDIA/eidos --log
```
